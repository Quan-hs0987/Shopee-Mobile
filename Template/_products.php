        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                        <?php 
                                if(in_array($item['item_id'], haystack: $Cart->getCartId($product->getData(table: 'cart')) ?? [])){
                                    echo '<button type="submit" disabled class = "btn btn-success font-size-16 form-control">In the cart</button>';
                                }else{
                                    echo '<button type="submit" name="top_sale_submit" class="btn btn-warning form-control font-size-16">Add to
                                    cart</button>'; 
                                }
                            ?>
                    </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">12.345 ratings | 1000 answered questions</a>
                </div>
                <hr class="m-0">
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save: </td>
                        <td class="font-size-16 text-danger">$ <span>152</span></td>
                    </tr>
                </table>
                <div id="policy">
                    <div class="d-flex">
            ...
            <div class="col-12">
                ...
                <hr>
                <p class="font-rale font-size-14">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur eum
                    iure suscipit iusto optio beatae animi repellat nisi ipsum id nam adipisci vel earum, architecto
                    maiores, temporibus, alias numquam eius!</p>
            </div>
        </div>
    </div>
</section>
